...
function adicionarProduto ($nome, $tipo, $preco, $cor, $fabricante, $descricao, $tamanho, $imagem, $categoria, $quantidade, $estoque_minimo, $estoque_maximo){
    $sql = "INSERT INTO produto (nomeproduto, tipo, preco, cor, fabricante, descricao, tamanho, imagem, idcategoria, quantidade, estoque_minimo, estoque_maximo) VALUES ('$nome', '$tipo', '$preco', '$cor', '$fabricante', '$descricao', '$tamanho', '$imagem', '$categoria', '$quantidade', '$estoque_minimo', '$estoque_maximo')";
